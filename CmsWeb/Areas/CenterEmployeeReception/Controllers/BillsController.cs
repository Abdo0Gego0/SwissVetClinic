...
namespace CmsWeb.Areas.CenterEmployeeReception.Controllers
{
    ...
    public class BillsController : Controller
    {
        ...
        public async Task<IActionResult> Index(Guid id)
        {
            ...
            return View("CenterEmployeeReception/_IndexBills");
        }
        ...
        {
            return View("CenterEmployeeReception/_Edit_Bill", cmsContext.VisistBill.Find(id));
        }

       /*
        public async Task<IActionResult> Create_Bill(VisistBill bill)
        {
            if (ModelState.IsValid)
            {
                var bil = new VisistBill()
                {
                    Id = Guid.NewGuid(),
                };
            }
            ...
            return View("CenterEmployeeReception/_Edit_Bill");
        }
       */
