...
namespace CmsWeb.Areas.CenterEmployeeReception.Controllers
{
    ...
    public class ReceiptsController : Controller
    {
        ...
        {
            return View("CenterEmployeeReception/_Receipt", await _context.Receipt.ToListAsync());
        }
        ...
        {
            return View("EditorTemplates/ReceiptEditor");
        }
        ...
        public async Task<IActionResult> Create(Receipt receipt)
        {
            ...
            {
                return View("EditorTemplates/ReceiptEditor", receipt);
            }
