...
namespace CmsWeb.Areas.CenterEmployeeOrders.Controllers
{
    [Area("CenterEmployeeOrders")]
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            return View("CenterEmployeeOrders/_EmployeeAdminIndex");
        ...
        public IActionResult MyAccount()
        {
            ...
            return View("CenterEmployeeOrders/_MyAccount", centerTutor);
