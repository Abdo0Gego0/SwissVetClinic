...
namespace CmsWeb.Areas.Center.Controllers
{
    ...
    public class DoctorController : Controller
    {
        ...
        public async Task<IActionResult> IndexSpeicality()
        {
            ...
            return View("CenterAdmin/_DoctorSpeicality");
        }
        ...
        public async Task<IActionResult> IndexDoctors()
        {
            ...
            return View("CenterAdmin/_Doctor");
        }

        public ActionResult Read_Doctor([DataSourceRequest] DataSourceRequest request, string preferredCulture = "en-US")
        {
            return Json(medicalCenterService.GetMyCenterDoctors(request, preferredCulture));
        }
        ...
        public async Task<IActionResult> Create_Doctor()
        {
            ...
            return View("CenterAdmin/_Doctor_Create");
        }


        [HttpPost]
        public async Task<IActionResult> Create_Doctor(Doctor model,List<Guid>? DoctorSpeciality1)
        {
            ...
            model.DoctorSpeciality = new List<DoctorSpeciality>();

            foreach (var item in DoctorSpeciality1)
            {
                model.DoctorSpeciality.Add(cmsContext.DoctorSpeciality.Find(item));
            }
            ...
            else
            {
                ...
                return View("CenterAdmin/_Doctor_Create",model);
            }
        ...
        public async Task<IActionResult> Edit_Doctor(Guid id)
        {
            ...
            return View("CenterAdmin/_Doctor_Edit", personService.GetDoctorById(id));
        }


        [HttpPost]
        public async Task<IActionResult> Edit_Doctor(Doctor model,List<Guid>? DoctorSpecialityId)
        {
...
.FirstOrDefault(a => a.Id == model.Id);
            ...
            centerTutor.DoctorSpeciality = new List<DoctorSpeciality>();
            cmsContext.Doctor.Update(centerTutor);
            cmsContext.Entry(centerTutor).State = EntityState.Modified;
            cmsContext.SaveChanges();

            foreach (var item in DoctorSpecialityId)
            {
                centerTutor.DoctorSpeciality.Add(cmsContext.DoctorSpeciality
                    .Include(a=>a.DoctorSpecialityTranslation)
        ...
        public async Task<IActionResult> Certificate_Doctor(Guid id)
        {
            ...
            ViewBag.DispalyName =_localizer["Doctor Certificates"];
            ViewBag.PreviousActionDispalyName = _localizer["Doctors"];
            ViewBag.PreviousAction = "IndexDoctors";
            ...
            return View("CenterAdmin/_Certificate_Doctor");
        }
