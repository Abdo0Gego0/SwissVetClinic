...
namespace CmsWeb.Areas.Admin.Controllers
{
    ...
    public class EmployeeController : Controller
    {
        ...
        public async Task<IActionResult> Create_Employee()
        {
            ...
            return View("Admin/_Employee_Create");
        }
        ...
        public async Task<IActionResult> Create_Employee(Employee model)
        {
            ...
            else
            {
                ...
                return View("Admin/_Employee_Create", model);
            }
        ...
        public async Task<IActionResult> Edit_Employee(Guid id)
        {
            ...
            return View("Admin/_Employee_Edit", personService.GetEmployeeById(id));
        }
