...
namespace CmsDataAccess.Migrations
{
    ...
    [Migration("20240628113914_newOutCome")]
    partial class newOutCome
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CmsDataAccess.DbModels.AccountVerificationToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CmsDataAccess.DbModels.Basket", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CmsDataAccess.DbModels.COrder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CmsDataAccess.DbModels.COrderItems", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("COrderId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("COrderItems");
                });

            modelBuilder.Entity("CmsDataAccess.DbModels.CenterMedicineList", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("CenterMedicineList");
                });

            modelBuilder.Entity("CmsDataAccess.DbModels.CenterMedicineUnit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("CenterMedicineListId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("SmallestUnit")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("Id");

                    b.HasIndex("CenterMedicineListId");

                    b.ToTable("CenterMedicineUnit");
                });
            ...
            modelBuilder.Entity("CmsDataAccess.DbModels.Favourite", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CmsDataAccess.DbModels.Outcome", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CmsDataAccess.DbModels.ProductReview", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CmsDataAccess.DbModels.VisistBill", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<double?>("MedicnieCost")
                        .HasColumnType("float");
                    ...
                    b.Property<DateTime?>("PaymenrDate")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("CmsDataAccess.DbModels.VisitMedicine", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CmsDataAccess.DbModels.COrderItems", b =>
                {
                    b.HasOne("CmsDataAccess.DbModels.COrder", null)
                        .WithMany("COrderItems")
                        .HasForeignKey("COrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("CmsDataAccess.DbModels.CenterMedicineUnit", b =>
                {
                    b.HasOne("CmsDataAccess.DbModels.CenterMedicineList", null)
                        .WithMany("CenterMedicineUnit")
                        .HasForeignKey("CenterMedicineListId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("CmsDataAccess.DbModels.COrder", b =>
                {
                    b.Navigation("COrderItems");
                });

            modelBuilder.Entity("CmsDataAccess.DbModels.CenterMedicineList", b =>
                {
                    b.Navigation("CenterMedicineUnit");
                });
